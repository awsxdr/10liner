...
5 q=ABS(((u(J)+v(J)*EM)MODD)-C)+20:IFq<gANDg<q+8ANDv(j)-8<hANDh<v(j)+8THENh=-1:v(j)=-10:n=n+1:ELSEIFv(j)>FTHEN9
6 PUTSPRITE30+J-1,(q,v(J)),8:v(J)=v(J)+EM:NEXTJ:PUTSPRITE21,(g,h),3:h=ABS(h)-10:s=ABS(STICK(0)+STRIG(0))
